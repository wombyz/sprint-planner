...
- If the chore involves E2E tests or test infrastructure, reference `.claude/commands/e2e/TEST_DATA_GUIDELINES.md` for test data patterns and mock data helpers.
