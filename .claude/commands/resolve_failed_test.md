...
- Fix the code to match expected types
- Run `pnpm tsc --noEmit` to verify

### Test Logic Errors
- Assertion failures
- Expected vs actual mismatches
- May indicate either buggy code OR outdated test
- Check if the spec changed recently
...
### Mock/Stub Issues
- "Mock not defined" or similar
- Check test setup and mock configurations
- Verify mock patterns match actual implementations
